    ...
    <div className="mx-auto flex min-h-screen max-w-md items-center px-6 py-12">
      <Card className="w-full border-white/10 bg-white/5">
        ...
        <CardContent className="space-y-6">
          {error && (
            <Alert variant={error === "AccountCreated" ? "success" : "destructive"}>
              {error === "Configuration"
                ? "Google OAuth is not configured. Please use email and password sign-in, or configure GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, and AUTH_SECRET in your environment variables."
              ...
              <form
                action={async () => {
                  ...
                  try {
                    ...
                    redirect(`/auth/login?error=Configuration&returnTo=${encodeURIComponent(returnTo)}`);
                  }
                }}
              >
